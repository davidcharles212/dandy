...
const PRODUCTS = [
  { title: 'Mixed Berry Kratom Gummies', handle: 'mixed-berry-kratom-gummies',
    ...
    variants: [
      { opts: ['10-count', 'Single'],  price: '24.99',  sku: 'DND-GUM-35-10' },
      { opts: ['30-count', 'Single'],  price: '59.99',  sku: 'DND-GUM-35-30' },
      { opts: ['30-count', '3-pack'],  price: '119.98', compareAt: '179.97', sku: 'DND-GUM-35-30-3PK' },
      { opts: ['30-count', '5-pack'],  price: '179.97', compareAt: '299.95', sku: 'DND-GUM-35-30-5PK' },
    ] },
  { title: 'Premium Kratom Leaf Powder', handle: 'premium-kratom-leaf-powder',
    ...
    options: ['Size', 'Pack'],
    variants: [
      { opts: ['100 g', 'Single'], price: '34.99',  sku: 'DND-POW-100' },
      { opts: ['100 g', '3-pack'], price: '69.98',  compareAt: '104.97', sku: 'DND-POW-100-3PK' },
      { opts: ['100 g', '5-pack'], price: '104.97', compareAt: '174.95', sku: 'DND-POW-100-5PK' },
      { opts: ['250 g', 'Single'], price: '54.99',  sku: 'DND-POW-250' },
      { opts: ['250 g', '3-pack'], price: '109.98', compareAt: '164.97', sku: 'DND-POW-250-3PK' },
      { opts: ['250 g', '5-pack'], price: '164.97', compareAt: '274.95', sku: 'DND-POW-250-5PK' },
    ] },
  { title: 'Extract Capsules · 50 mg', handle: 'extract-capsules-50mg',
    ...
    options: ['Count', 'Pack'],
    variants: [
      { opts: ['10-count', 'Single'], price: '28.99',  sku: 'DND-CAP-50-10' },
      { opts: ['10-count', '3-pack'], price: '57.98',  compareAt: '86.97',  sku: 'DND-CAP-50-10-3PK' },
      { opts: ['10-count', '5-pack'], price: '86.97',  compareAt: '144.95', sku: 'DND-CAP-50-10-5PK' },
      { opts: ['30-count', 'Single'], price: '64.99',  sku: 'DND-CAP-50-30' },
      { opts: ['30-count', '3-pack'], price: '129.98', compareAt: '194.97', sku: 'DND-CAP-50-30-3PK' },
      { opts: ['30-count', '5-pack'], price: '194.97', compareAt: '324.95', sku: 'DND-CAP-50-30-5PK' },
    ] },
  { title: 'Extract Capsules · 90 mg', handle: 'extract-capsules-90mg',
    ...
    options: ['Count', 'Pack'],
    variants: [
      { opts: ['10-count', 'Single'], price: '44.99',  sku: 'DND-CAP-90-10' },
      { opts: ['10-count', '3-pack'], price: '89.98',  compareAt: '134.97', sku: 'DND-CAP-90-10-3PK' },
      { opts: ['10-count', '5-pack'], price: '134.97', compareAt: '224.95', sku: 'DND-CAP-90-10-5PK' },
      { opts: ['30-count', 'Single'], price: '99.99',  sku: 'DND-CAP-90-30' },
      { opts: ['30-count', '3-pack'], price: '199.98', compareAt: '299.97', sku: 'DND-CAP-90-30-3PK' },
      { opts: ['30-count', '5-pack'], price: '299.97', compareAt: '499.95', sku: 'DND-CAP-90-30-5PK' },
    ] },
];
